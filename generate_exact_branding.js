...
// Shape is a tilted Mobius / figure-8:
// Left/Bottom loop is large, wide, tilted down-left.
// Top-right loop is smaller, slender, extending up-right at ~45 deg angle.
// Smooth single ribbon band with realistic metallic gradient and seamless crossover.
const iconSvg = `
<svg width="1024" height="1024" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
  ...
  <!-- The True Infinity/Mobius Loop exactly matching the user's design -->
  <!-- Center is around (512, 512). It sweeps from bottom-left bulbous loop to top-right slender elongated loop -->
  <g id="symbol">
...
// 2) Exact ABHIAI Logo Banner (1800 x 600)
// Features:
// - Left: 3D Infinity Metallic loop symbol
// - Right: Exact custom rounded capsule typography "A B H I A I" from user's image!
// Look closely at user image letters:
// - A: Rounded arch top, flat horizontal bar, two legs with rounded bottom terminals
// - B: Rounded vertical back with rounded corners, horizontal middle bar, rounded capsule shape
// - H: Two rounded vertical pills joined by a middle horizontal bar
// - I: Single vertical rounded pill
// - A: Same exact A
// - I: Same vertical rounded pill
// Spacing between letters is generous and perfectly tracked.
const logoSvg = `
<svg width="1800" height="600" viewBox="0 0 1800 600" xmlns="http://www.w3.org/2000/svg">
  <defs>
    <!-- Dark subtle background -->
    <rect id="bgRect" width="1800" height="600" fill="#0b0c0e" />
  ...
  <!-- Left: The 3D Infinity Loop Symbol (Scale and translate) -->
  ...
  <!-- Letters have a bold thickness of ~18px, rounded outer caps (radius 22px), pure white #FFFFFF -->
  <g transform="translate(680, 240)" fill="#FFFFFF">
    
    <!-- Letter 'A' (1) -->
    <!-- Custom geometric rounded arch with middle bar -->
    ...
    <!-- Letter 'B' -->
    <!-- Distinctive pill-like B with rounded outer shell and center crossbar -->
    ...
    <!-- Letter 'H' -->
    <!-- Two rounded vertical strokes with center crossbar -->
