...
import type { AgentToolContext, AgentToolResult } from '@/lib/ai/tools';
...
type ServerToolContext = Omit<AgentToolContext, 'executeTool'>;
...
export async function executeAgentTool(
  ...
  if (name === 'document_qa') {
    const attachments = (context.attachments ?? []) as AttachmentPayload[];
