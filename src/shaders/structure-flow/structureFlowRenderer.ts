  ...
  return {
    ...
    render() {
      ...
      if (options.color !== undefined) {
        material.color.set(options.color as any);
        if (typeof options.color === 'string' && (options.color.startsWith('#2') || options.color.startsWith('#3') || options.color.startsWith('#1') || options.color.startsWith('#4') || options.color.startsWith('#0'))) {
          material.blending = THREE.NormalBlending;
        } else if (typeof options.color === 'number' && options.color !== 0xffffff) {
          material.blending = THREE.NormalBlending;
        } else {
